        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/categories/add-categories" &&
                                "text-white"
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              href="/categories/categories-view"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/categories/categories-view" &&
                                "text-white"
                              } `}
                            >
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/articles" || pathname.includes("forms")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/articles/add-articles"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/articles/add-articles" &&
                                "text-white"
                              }`}
                            >
                              Add Articles
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/magazines" || pathname.includes("forms")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/magazines/add-magazine"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/magazines/add-magazine" &&
                                "text-white"
                              }`}
                            >
                              Add Magazine
                          ...
                          <li>
                            <Link
                              href="/magazines/magazines-list"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/magazines/magazines-list" &&
                                "text-white"
                              } `}
                            >
                              Magazines View
